---
title: "An AI-Powered 'KBS Jeju Election Coverage Center': Cheju Halla AI Department Drives Korea's First Local Case"
description: "The AI Department at Cheju Halla University and KBS Jeju jointly built an AI-powered election platform, KBS Jeju Election Coverage Center (vote-jejukbs.kr). With AI district-issue analysis, a policy knowledge graph, and a voter Q&A board, it is the first AI-meets-election collaboration by any Jeju newsroom."
date: 2026-05-15
image: "/images/posts/2026-05-15-kbs-jeju-election-center-ai/01-election-center-hero.jpg"
tags: [AI, Election Coverage, KBS, Industry Collaboration, AI Department]
categories: Education
draft: false
---

The Department of AI at Cheju Halla University (Prof. Young Joon Lee's research team) and KBS Jeju have jointly launched **'KBS Jeju Election Coverage Center'** ([vote-jejukbs.kr](https://www.vote-jejukbs.kr)), an AI-powered platform unveiled on May 15, just 19 days before Korea's June 3 local elections. It is **the first 'AI × election coverage' case ever produced by a newsroom on Jeju Island**, designed to help local voters, too often sidelined in Seoul-centric election broadcasts, explore election information more easily and in greater depth.
...
![KBS feature, "AI-analyzed local election issues"](/images/posts/2026-05-15-kbs-jeju-election-center-ai/02-ai-district-analysis-broadcast.jpg)
...
![Interactive map of Jeju's 32 electoral districts](/images/posts/2026-05-15-kbs-jeju-election-center-ai/03-jeju-32-districts-map.jpg)
...
![Policy knowledge graph, structured view of top, five-pledge, sector, and stance nodes](/images/posts/2026-05-15-kbs-jeju-election-center-ai/04-policy-knowledge-graph.jpg)

### Voter Participation: A Direct Channel to Candidates

The platform does not stop at consumption. It is built so that **voters can directly post questions** to candidates for governor, education superintendent, provincial council, proportional representation, and the Seogwipo parliamentary by-election; questions are sorted by topic and district. Candidates then reply to those questions in-thread. Politicians who used to feel distant and voters who used to feel unheard now meet on a single digital town square.

![Voter Q&A board, "Jeju asks the candidates"](/images/posts/2026-05-15-kbs-jeju-election-center-ai/05-voter-question-board.jpg)

![Candidate response cards, "Your neighbors' questions"](/images/posts/2026-05-15-kbs-jeju-election-center-ai/06-candidate-responses.jpg)

### Designing for Trust: AI Curation + Human Editorial Review

The hardest problem in applying AI to election coverage is **trust**. Rather than naively pulling articles that simply contain the word "election," the team designed the system to gather and organize stories with full **context**: candidates, parties, districts, pledges, and polling data. They also built in a two-layer safeguard: an editor makes the **final call on what is published**, on top of the AI's automatic classification, blocking the risk of AI making arbitrary editorial decisions on its own.

![Prof. Young Joon Lee on KBS](/images/posts/2026-05-15-kbs-jeju-election-center-ai/07-prof-lee-interview.jpg)
