...
<div class="mermaid">
graph TD
    classDef track fill:#c7bed7,stroke:#333,stroke-width:5px,rx:20px,ry:20px,font-size:80px,font-family:Hahmlet;
    ...
    classDef goal fill:#022f44,color:#fff,stroke:#005a83,stroke-width:5px,rx:20px,ry:20px,font-size:80px,font-family:Hahmlet;
